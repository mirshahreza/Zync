...
VALUES (0, @ActOn, 1,  1, 'admin', 'admin@system.local', '161EBD7D45089B3446EE4E0D86DBCF92', 0, @ActOn, 1,  1, 0, 0);
...
VALUES (@ActorId, @ActOn, 1,  'Developer', 1, 'Full access', 1);

INSERT INTO BaseRoles (CreatedBy, CreatedOn, RoleName, IsActive, Note, IsBuiltIn)
VALUES (@ActorId, @ActOn, 1,  'BackOfficer', 1, 'Admin access', 1);
...
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.1','Approved',     'Approved',     N'تاييد شده',    N'مقبول'        );
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.2','UnderReview',  'Under Review', N'درحال بررسي', N'قيد المراجعة');
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.3','Rejected',     'Rejected',     N'رد شده',      N'مرفوض'        );
...
INSERT INTO BasePersons (CreatedBy,CreatedOn,GenderId,EntityTypeId,RecordStateId,FirstName,LastName,Mobile,UserId) VALUES (@ActorId,@ActOn, 1, '100.1','101.1','102.1',N'Admin', N'Admin', '09121234567',@ActorId);
