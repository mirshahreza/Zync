...
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,UiIcon,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.2','fa-solid fa-fw fa-drafting-compass text-warning',  'Draft',            'Draft',        N'پيشنويس',     N'مسودة'            );
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,UiIcon,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.3','fa-solid fa-fw fa-clock-four text-primary',        'UnderReview',      'Under Review', N'درحال بررسي', N'قيد المراجعة'     );
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,UiIcon,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '101', '101.4','fa-solid fa-fw fa-ban text-danger',                'Rejected',         'Rejected',     N'رد شده',      N'مرفوض'            );
