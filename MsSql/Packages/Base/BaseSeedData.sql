...
VALUES (0, GETDATE(), 'Developer', 1, 'Full access', 1);CREATE OR ALTER PROCEDURE [dbo].[ZzBaseSeedData]-- Description: Simple seed data - 3 records only

INSERT INTO BaseRole (CreatedBy, CreatedOn, RoleName, IsActive, Note, IsBuiltIn)AS
...
VALUES (0, GETDATE(), 1, 'admin', 'admin@system.local', '8BE3C943B1609FFFBFC51AAD666D0A04ADF83C9D7A54592EA634F5DD196AF4F1', 0, GETDATE(), 1, 0, 0);    SET NOCOUNT ON;
