...
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '150', '150.01',  'َArticle',          'َArticle',          N'مقاله',           N'مقالة'        );
...
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   NULL,  '153',     'ContentRenderTemplate',    'Content Render Template',          N'شکل نمایش',               N'قالب العرض'    );
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '153', '153.01',  'Title',                    'Title',                            N'عنوان',                   N'العنوان'       );
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '153', '153.02',  'TitleSummery',             'Title + Summery',                  N'عنوان + خلاصه',            N'العنوان + الملخص');
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '153', '153.03',  'TitleSummeryBody',         'Title + Summery + Body',           N'عنوان + خلاصه + متن',      N'العنوان+الملخص+المتن');
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '153', '153.04',  'TitleSummeryBodyFile',     'Title + Summery + Body + File',    N'عنوان+خلاصه+متن+فایل',    N'العنوان+الملخص+المتن+ملف');
INSERT INTO BaseInfo (CreatedBy, CreatedOn,IsActive,ParentId,Id,Title,TitleEn,TitleFa,TitleAr) VALUES (@ActorId, @ActOn, 1,   '153', '153.05',  'SideFileTitleSummery',     'SideFile + Title + Summery',       N'فایل جانبی+عنوان+خلاصه',  N'ملف جانبي+العنوان+الملخص');
